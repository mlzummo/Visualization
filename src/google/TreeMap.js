...
(function (root, factory) {
    ...
    TreeMap.prototype.getChartOptions = function () {
        ...
        retVal.generateTooltip = TreeMap.prototype.defaultlTooltip;
        return retVal;
    };
    ...
    TreeMap.prototype.update = function (domNode, element) {
        ...
        TreeMap.prototype.mapData = this._data_google;
    ...
    TreeMap.prototype.testData = function () {
        var context = this;
        function setColumns(_callback) {
             context.columns([['Location', 'Parent', 'Market trade volume (size)', 'Market increase/decrease (color)']]);
             _callback();
        }
    ...
    TreeMap.prototype.defaultlTooltip = function(row, size, value) {
        var data =  TreeMap.prototype.mapData;
