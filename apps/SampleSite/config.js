...
if (window.location.hostname === "rawgit.com") {
    require.config({
        paths: {
            ...
            "font-awesome": "//rawgit.com/FontAwesome/Font-Awesome/v4.3.0/css/font-awesome.min",
...
if (window.location.hostname === "cdn.rawgit.com") {
    require.config({
        paths: {
            ...
            "font-awesome": "//cdn.rawgit.com/FontAwesome/Font-Awesome/v4.3.0/css/font-awesome.min",
